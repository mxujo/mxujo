...
install(){    
    ...
    wget https://raw.githubusercontent.com/mxujo/mxujo/main/scripts/run.sh -O /root/x_miner_proxy/run.sh
    chmod 777 /root/x_miner_proxy/run.sh
    wget https://raw.githubusercontent.com/mxujo/mxujo/main/others/server.key -O /root/x_miner_proxy/server.key
    wget https://raw.githubusercontent.com/mxujo/mxujo/main/others/server.pem -O /root/x_miner_proxy/server.pem
    
    wget https://github.com/mxujo/mxujo/releases/download/99.0.5/XMinerProxy_v99.0.5_linux_amd64.tar.gz -O /root/XMinerProxy_v99.0.5_linux_amd64.tar.gz
    tar -zxvf /root/XMinerProxy_v99.0.5_linux_amd64.tar.gz -C /root/x_miner_proxy
    ...
    sleep 2s
    echo "XMinerProxy V99.0.5已经安装到/root/x_miner_proxy"
...
update(){
    ...
    sleep 2s
    echo "XMinerProxy 已经更新至V99.0.5版本并启动"
    cat /root/x_miner_proxy/pwd.txt
    echo ""
